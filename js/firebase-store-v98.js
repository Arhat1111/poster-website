...
async function loadMergedData(baseData, options = {}) {
  ...
  try {
    ...
    base.products = products.length ? products : legacyProducts;
    base.categories = categories.length ? categories : legacyCategories;
...
window.INKWAVES_FIREBASE = {
  ...
  loadMergedData, saveWholeStore, optimizeCatalogMedia,
